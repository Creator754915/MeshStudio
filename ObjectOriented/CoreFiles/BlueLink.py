...
class BlueLink(Button):
    ...
    def __init__(self, text='...', radius=0.1, ToSubtract=0, Key=None, partKey="", on_key_press=None, on_hover=None,
                 on_unhover=None, hover_highlight=False, hover_highlight_color=color.white, hover_highlight_size=0.2,
                 hover_highlight_button=False, **kwargs) -> None:
        super().__init__(text, radius, ToSubtract, Key, partKey, on_key_press, on_hover, on_unhover, hover_highlight,
                         hover_highlight_color, hover_highlight_size, hover_highlight_button, **kwargs)

        self.MouseCursor: Cursor = Cursor(model="cube", texture="../Images/BlueLinkMouse", scale=.033, enabled=False,
                                          collider=None, color=color.white)
